...
public class Test {
	...
	public static void main(String[] args) {
		...
		// testing
		Block block1 = new Block(blockchain.get(blockchain.size() - 1).getIndex() + 1, genesis.hash);
		...
		Block block2 = new Block(blockchain.get(blockchain.size() - 1).getIndex() + 1, block1.hash);
		...
		Block block3 = new Block(blockchain.get(blockchain.size() - 1).getIndex() + 1, block2.hash);
		...
		if (isChainValid()) {
			...
			try {
				...
				myWriter.write(Block.ExploreBlock(blockchain));
				System.out.println("Block chain is saved");
				myWriter.close();
